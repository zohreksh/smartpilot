...
import { L as ListenOptions, a as Listener } from './shared/listhen.Dh3trXcM.cjs';
export { C as Certificate, b as CrossWSOptions, E as ExtraURL, G as GetURLOptions, H as HTTPSOptions, c as ListenURL, S as ShowURLOptions } from './shared/listhen.Dh3trXcM.cjs';
...
declare function createDevServer(entry: string, options: DevServerOptions): Promise<{
    ...
    resolver: {
        ...
        resolveFrom: (id: string, dirs: string[]) => string;
    };
