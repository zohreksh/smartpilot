...
import { v as version, b as isDocker, a as isDoNotTrack, i as isTruthy, e as ensureUserconsent, u as updateUserNuxtRc } from './shared/telemetry.qVlICZgB.mjs';
import os from 'node:os';
import fs, { existsSync, readFileSync } from 'node:fs';
import { execSync } from 'node:child_process';
import { detectAgent, isAgent, provider } from 'std-env';
