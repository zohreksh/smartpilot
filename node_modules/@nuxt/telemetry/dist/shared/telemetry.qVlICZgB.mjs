...
function isDoNotTrack(env = process.env) {
  return isTruthy(env.DO_NOT_TRACK);
}

export { RC_FILENAME as R, isDoNotTrack as a, isDocker as b, consentVersion as c, ensureUserconsent as e, isTruthy as i, updateUserNuxtRc as u, version as v };
