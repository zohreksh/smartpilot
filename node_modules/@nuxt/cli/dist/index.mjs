...
const commands = {
	"add": () => import("./add-CFBz9qUQ.mjs").then(_rDefault),
	"add-template": () => import("./add-template-D9MCPMwQ.mjs").then(_rDefault),
	"analyze": () => import("./analyze-C2iCFCvd.mjs").then(_rDefault),
	"build": () => import("./build-BruCr8zc.mjs").then(_rDefault),
	"cleanup": () => import("./cleanup-D_unOr8Y.mjs").then(_rDefault),
	"_dev": () => import("./dev-child-CFSv-rE7.mjs").then(_rDefault),
	"dev": () => import("./dev-Cbii5ek4.mjs").then(_rDefault),
	"devtools": () => import("./devtools-DisdwL4R.mjs").then(_rDefault),
	"generate": () => import("./generate-DdPjGZ_d.mjs").then(_rDefault),
	"info": () => import("./info-BKzYVsnn.mjs").then(_rDefault),
	"init": () => import("./init-CxoqT_5r.mjs").then(_rDefault),
	"module": () => import("./module-CCsmW23E.mjs").then(_rDefault),
	"prepare": () => import("./prepare-kyMoAaxl.mjs").then((n) => n.n).then(_rDefault),
	"preview": () => import("./preview-CuCcSe55.mjs").then(_rDefault),
	"start": () => import("./preview-CuCcSe55.mjs").then(_rDefault),
	"test": () => import("./test-CmZfAqxV.mjs").then(_rDefault),
	"typecheck": () => import("./typecheck-BXVxFdHw.mjs").then(_rDefault),
	"upgrade": () => import("./upgrade-Cr7XHlaS.mjs").then(_rDefault)
};
//#endregion
