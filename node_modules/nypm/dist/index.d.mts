 ...
 */
export declare function installDependencies(options?: Pick<OperationOptions, "cwd" | "silent" | "packageManager" | "dry" | "corepack"> & {
 ...
 */
export declare function addDependency(name: string | string[], options?: OperationOptions): Promise<OperationResult>;
/**
 ...
 *
 */
export declare function addDevDependency(name: string | string[], options?: Omit<OperationOptions, "dev">): Promise<OperationResult>;
/**
 ...
 * @param options.global - Whether to run the command in global mode.
 */
export declare function removeDependency(name: string | string[], options?: OperationOptions): Promise<OperationResult>;
/**
 ...
 */
export declare function dedupeDependencies(options?: Pick<OperationOptions, "cwd" | "silent" | "packageManager" | "dry" | "corepack"> & {
 ...
 */
export declare function runScript(name: string, options?: Pick<OperationOptions, "cwd" | "env" | "silent" | "packageManager" | "dry" | "corepack"> & {
  args?: string[];
}): Promise<OperationResult>;
/**
 ...
 */
export declare function dlx(name: string, options?: Pick<OperationOptions, "cwd" | "env" | "silent" | "packageManager" | "dry" | "corepack"> & {
  args?: string[];
  short?: boolean;
  packages?: string[];
}): Promise<OperationResult>;
 ...
 */
export declare function installDependenciesCommand(packageManager: PackageManagerName, options?: {
  short?: boolean;
  frozenLockFile?: boolean;
}): string;
/**
 ...
 */
export declare function addDependencyCommand(packageManager: PackageManagerName, name: string | string[], options?: {
  dev?: boolean;
  global?: boolean;
  yarnBerry?: boolean;
  workspace?: boolean | string;
 ...
 */
export declare function runScriptCommand(packageManager: PackageManagerName, name: string, options?: {
  args?: string[];
}): string;
/**
 * Get the command to download and execute a package with the package manager.
 */
export declare function dlxCommand(packageManager: PackageManagerName, name: string, options?: {
  args?: string[];
  short?: boolean;
  packages?: string[];
}): string;