...
function parseAttributes(attrStr) {
  if (!attrStr)
    return {};
  const result = {};
  const setAttr = (name2, value) => {
    if (!hasOwn(result, name2))
      result[name2] = value;
  };
...
export { TagIdMap as T, applyHeadToHtml as a, parseHtmlForIndexes as b, parseAttributes as c, hasOwn as h, parseHtmlForUnheadExtraction as p };
