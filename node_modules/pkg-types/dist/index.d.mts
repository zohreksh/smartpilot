 ...
 */
export declare function findFile(filename: string | string[], _options?: FindFileOptions): Promise<string>;
/**
 ...
 */
export declare function findNearestFile(filename: string | string[], options?: FindFileOptions): Promise<string>;
/**
 ...
 */
export declare function findFarthestFile(filename: string | string[], options?: FindFileOptions): Promise<string>;
interface TSConfig {
 ...
 */
export declare function defineTSConfig(tsconfig: TSConfig): TSConfig;
/**
 ...
 */
export declare function readTSConfig(id?: string, options?: ResolveOptions & ReadOptions): Promise<TSConfig>;
/**
 ...
 */
export declare function writeTSConfig(path: string, tsconfig: TSConfig): Promise<void>;
/**
 ...
 */
export declare function resolveTSConfig(id?: string, options?: ResolveOptions): Promise<string>;
 ...
 */
export declare function definePackageJSON(pkg: PackageJson): PackageJson;
/**
 ...
 */
export declare function findPackage(id?: string, options?: ResolveOptions): Promise<string>;
/**
 ...
 */
export declare function readPackage(id?: string, options?: ResolveOptions & ReadOptions): Promise<PackageJson>;
/**
 ...
 */
export declare function writePackage(path: string, pkg: PackageJson): Promise<void>;
/**
 ...
 * @returns a promise resolving to the parsed `package.json` object.
 */
export declare function readPackageJSON(id?: string, options?: ResolveOptions & ReadOptions): Promise<PackageJson>;
/**
 ...
 */
export declare function writePackageJSON(path: string, pkg: PackageJson): Promise<void>;
/**
 ...
 */
export declare function resolvePackageJSON(id?: string, options?: ResolveOptions): Promise<string>;
/**
 ...
 */
export declare function resolveLockfile(id?: string, options?: ResolveOptions): Promise<string>;
 ...
 */
export declare function findWorkspaceDir(id?: string, options?: ResolveOptions & Partial<Record<WorkspaceTestName, boolean | "closest" | "furthest">> & {
 ...
 */
export declare function updatePackage(id: string, callback: (pkg: PackageJson) => PackageJson | void | Promise<PackageJson | void>, options?: ResolveOptions & ReadOptions): Promise<void>;
/**
 ...
 */
export declare function sortPackage(pkg: PackageJson): PackageJson;
/**
 ...
 */
export declare function normalizePackage(pkg: PackageJson): PackageJson;
interface GitRemote {
  [key: string]: unknown;
  name?: string;
  url?: string;
 ...
 */
export declare function defineGitConfig(config: GitConfig): GitConfig;
/**
 * Finds closest `.git/config` file.
 */
export declare function resolveGitConfig(dir: string, opts?: ResolveOptions): Promise<string>;
/**
 * Finds and reads closest `.git/config` file into a JS object.
 */
export declare function readGitConfig(dir: string, opts?: ResolveOptions): Promise<GitConfig>;
/**
 * Stringifies git config object into INI text format and writes it to a file.
 */
export declare function writeGitConfig(path: string, config: GitConfig): Promise<void>;
/**
 * Parses a git config file in INI text format into a JavaScript object.
 */
export declare function parseGitConfig(ini: string): GitConfig;
/**
 * Stringifies a git config object into a git config file INI text format.
 */
export declare function stringifyGitConfig(config: GitConfig): string;
