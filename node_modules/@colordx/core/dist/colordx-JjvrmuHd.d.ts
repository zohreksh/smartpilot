...
type SrgbLinearColorInput = Omit<SrgbLinearColor, 'alpha'> & {
    alpha?: number;
};
/** Any color input accepted by `colordx()` and friends — a CSS string or one of the input objects. */
type AnyColor = string | RgbColorInput | HslColorInput | HsvColorInput | HwbColorInput | LabColorInput | LchColorInput | XyzColorInput | XyzD65ColorInput | CmykColorInput | OklabColorInput | OklchColorInput | P3ColorInput | Rec2020ColorInput | A98ColorInput | ProPhotoColorInput | SrgbLinearColorInput;
...
type ColorFormat = 'hex' | 'rgb' | 'hsl' | 'hsv' | 'hwb' | 'oklab' | 'oklch' | 'lab' | 'lch' | 'xyz' | 'xyz-d65' | 'cmyk' | 'p3' | 'rec2020' | 'a98-rgb' | 'prophoto-rgb' | 'srgb-linear' | 'name';
...
export { type AnyColor as A, colordx as B, type ColorFormat as C, extend as D, nearest as E, random as F, toHex8 as G, type HslColor as H, type XyzD65Color as I, type LabColor as L, type OklabColor as O, type P3Color as P, type Rec2020Color as R, type SrgbLinearColor as S, type XyzColor as X, type A98Color as a, type A98ColorInput as b, type CmykColor as c, type CmykColorInput as d, type ColorParser as e, Colordx as f, type HslColorInput as g, type HsvColor as h, type HsvColorInput as i, type HwbColor as j, type HwbColorInput as k, type LabColorInput as l, type LchColor as m, type LchColorInput as n, type OklabColorInput as o, type OklchColor as p, type OklchColorInput as q, type P3ColorInput as r, type Plugin as s, type ProPhotoColor as t, type ProPhotoColorInput as u, type Rec2020ColorInput as v, type RgbColor as w, type RgbColorInput as x, type SrgbLinearColorInput as y, type XyzColorInput as z };
