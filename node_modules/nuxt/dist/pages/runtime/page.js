    ...
    return () => {
      return h(RouterView, { name: props.name, route: props.route, ...attrs }, {
        default: markStableSlot(import.meta.server ? (routeProps) => {
          ...
          let keepaliveConfig;
          const shouldAugmentInclude = keepAliveInclude.size > 0 && props.keepalive == null && (!routeKeepaliveConfig || typeof routeKeepaliveConfig === "object" && routeKeepaliveConfig && routeKeepaliveConfig.include);
          if (shouldAugmentInclude) {
            ...
            keepaliveConfig = { ...baseConfig, include: Array.from(/* @__PURE__ */ new Set([...existingInclude, ...keepAliveInclude])) };
          } else {
