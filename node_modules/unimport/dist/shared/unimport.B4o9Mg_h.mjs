...
const RE_CONTEXT$1 = /resolveDirective as _resolveDirective/;
const contextText = `${RE_CONTEXT$1.source}, `;
...
function vueDirectivesAddon(options = {}) {
  ...
  const self = {
    ...
    async transform(s, id) {
      if (!RE_CONTEXT$1.test(s.original))
        return s;
...
export { RE_EXCLUDE as R, VUE_TEMPLATE_NAME as V, vueTemplateAddon as a, RE_IMPORT_AS as b, RE_MATCH as c, RE_SEPARATOR as d, addImportToCode as e, dedupeImports as f, defineUnimportPreset as g, excludeRE as h, getMagicString as i, getString as j, importAsRE as k, stringifyImports as l, matchRE as m, normalizeImports as n, stripCommentsAndStrings as o, stripFileExtension as p, toImports as q, resolveIdAbsolute as r, separatorRE as s, toExports as t, toTypeDeclarationFile as u, vueDirectivesAddon as v, toTypeDeclarationItems as w, toTypeReExports as x, VUE_DIRECTIVES_NAME as y };
