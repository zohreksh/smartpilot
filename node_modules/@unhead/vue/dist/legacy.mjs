...
import { h as headSymbol } from './shared/vue.Cd6dkybA.mjs';
import { V as VueResolver } from './shared/vue.N9zWjxoK.mjs';
import { createHead as createHead$2 } from './server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin, defineHeadPlugin, SafeInputPlugin, FlatMetaPlugin } from 'unhead/plugins';
import { walkResolver } from 'unhead/utils';
import 'unhead/client';
import './shared/vue.BuDgoFqp.mjs';
...
export { CapoPlugin, createHead, createHeadCore, createServerHead, injectHead, legacyPlugins, resolveUnrefHeadInput, setHeadInjectionHandler, useHead, useHeadSafe, useSeoMeta, useServerHead, useServerHeadSafe, useServerSeoMeta };
