...
function getRecordImportPath(id, pathRecordDist, resolveRecordEntryPath) {
...
function VueTracer(options) {
  ...
  const getRecordPath = (id) => getRecordImportPath(id, pathRecordDist, resolveRecordEntryPath);
  return {
