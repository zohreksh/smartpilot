      ...
      <div class="contact-grid">
        <article class="contact-card info-card">
          ...
          <div class="contact-item">
            <strong>ایمیل</strong><span>hello@studio.com</span>
          </div>
          <div class="contact-item">
            <strong>تلفن</strong><span>+98 21 0000 0000</span>
          </div>
          <div class="contact-item">
        ...
        <article class="contact-card process-card">
          ...
          <div class="process-item">
            <span>01</span><strong>گفتگو</strong
            ><small>شناخت نیازها و اهداف پروژه</small>
          </div>
          <div class="process-item">
            <span>02</span><strong>طراحی مسیر</strong
            ><small>انتخاب راهکار و برنامه اجرا</small>
          </div>
          <div class="process-item">
            <span>03</span><strong>ساخت محصول</strong
            ><small>توسعه و تحویل با تمرکز روی کیفیت</small>
          </div>
        </article>
      </div>
    </section>
